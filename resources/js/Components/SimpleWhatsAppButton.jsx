...
const SimpleWhatsAppButton = ({ 
    ...
    const getVariantClasses = () => {
        switch (variant) {
            ...
            case 'ghost':
                return 'bg-transparent text-green-500 hover:bg-green-500 hover:text-white';
            case 'mobile':
                return 'bg-green-500 text-white shadow-lg hover:bg-green-600 transform hover:scale-105';
            default:
