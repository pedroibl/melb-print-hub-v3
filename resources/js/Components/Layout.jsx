...
export default function Layout({
    ...
    const socialLinks = [
        ...
        {
            name: "Instagram",
            href: "https://www.instagram.com/melb_print_hub",
        ...
        {
            name: "Pinterest",
            href: "https://au.pinterest.com/melbprinthub/",
            icon: (props) => (
                <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
                            ...
                            <nav className="hidden md:flex items-center space-x-8">
                                ...
                                <button
                                    onClick={() => {
                                        ...
                                        const message =
                                            "Hi! I have a printing question. Can you help?";
                ...
                <footer className="bg-gray-800 text-white">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
                            ...
                            <div className="space-y-4">
                                ...
                                <p className="text-gray-300 text-sm mb-4">
                                    Core printing services for everyday business
                                    needs
                                </p>
                            ...
                            <div className="space-y-4">
                                ...
                                <p className="text-gray-300 text-sm mb-4">
                                    Professional banner and display solutions
                            ...
                            <div className="space-y-4">
                                ...
                                <p className="text-gray-300 text-sm mb-4">
                                    Premium signage and display materials for
                                    maximum impact
                                </p>
                                <ul className="space-y-2">
                                    <li>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
                            ...
                            <div className="space-y-4">
                                ...
                                <p className="text-gray-300 text-sm">
                                    ...
                                    Melbourne businesses. Fast turnaround and
                                    competitive pricing.
                                </p>
                                <div className="space-y-2 text-sm text-gray-300">
                                    <p>
                                        <strong>Address:</strong> 58 Leonard
                                        Avenue, Noble Park VIC 3174
                                    </p>
                                    <p>
                                        <strong>Opening Hours:</strong> Monday
                                        to Friday, 08:00 AM to 06:00 PM
                                    </p>
                                    <p>
                            ...
                            <div className="space-y-4">
                                ...
                                <p className="text-gray-300 text-sm mb-4">
                                    Get your professional printing project
                        ...
                        <div className="border-t border-gray-700 pt-8 text-center text-gray-300">
                            <p className="text-sm">
                                &copy; {new Date().getFullYear()} Melbourne
                                Print Hub. All rights reserved.
                            </p>
                            <p className="text-xs mt-2">
                                Professional printing solutions for Melbourne
                                businesses
                            </p>
                        </div>
                    </div>
